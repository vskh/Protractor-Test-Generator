...
interface MediaStreamTrack extends EventTarget {
    ...
    applyConstraints(constraints: MediaTrackConstraints): Promise.IThenable<void>;
}
...
interface MediaDevices {
    ...
    getUserMedia(constraints: MediaStreamConstraints): Promise.IThenable<MediaStream>;
    enumerateDevices(): Promise.IThenable<MediaDeviceInfo[]>;
}
